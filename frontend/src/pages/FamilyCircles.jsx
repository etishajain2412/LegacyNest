...
export default function FamilyCircles() {
  ...
  const fetchUserCircles = async () => {
    try {
      ...
      // Check if user has admin privileges in any circle
  ...
  // Define tabs - always show My Requests and Admin Requests as separate tabs
  const allTabs = [
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Family Circles</h2>
          ...
          {activeTab === "myCircles" && (
            <div>
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-2xl font-semibold text-gray-900">My Family Circles</h3>
                <button
              ...
              {loading ? (
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                  {circles.map((circle) => (
                    <div key={circle._id} className="bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200">
                      <div className="p-6">
                        <div className="flex justify-between items-start mb-3">
                          <h4 className="text-lg font-semibold text-gray-900 truncate">{circle.name}</h4>
                          <div className="flex gap-1 ml-2">
                            {isUserCreator(circle) && (
                              <span className="bg-purple-100 text-purple-800 px-2 py-1 rounded-full text-xs font-medium">Creator</span>
                            )}
          ...
          {activeTab === "create" && (
            <div className="max-w-2xl mx-auto">
              <div className="bg-white rounded-lg">
                <div className="mb-8">
                  <h3 className="text-2xl font-semibold text-gray-900 mb-2">Create New Circle</h3>
          ...
          {activeTab === "join" && (
            <div className="max-w-2xl mx-auto">
              <div className="bg-white rounded-lg">
                <div className="mb-8">
                  <h3 className="text-2xl font-semibold text-gray-900 mb-2">Join a Circle</h3>
          ...
          {activeTab === "myRequests" && (
            <div>
              <h3 className="text-2xl font-semibold text-gray-900 mb-6">My Pending Join Requests</h3>
                    ...
                    <div key={index} className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-600 mb-4">
                        ...
                        <div className="flex items-center">
                          ...
                          <strong>Circle ID:</strong> <code className="ml-1 bg-gray-100 px-2 py-1 rounded text-xs font-mono">{item.circle._id}</code>
                        </div>
                      </div>
          ...
          {activeTab === "adminRequests" && (
            <div>
              <h3 className="text-2xl font-semibold text-gray-900 mb-6">Pending Join Requests for Your Circles</h3>
                    ...
                    <div key={index} className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-600 mb-6">
                        ...
                        <div className="flex items-center">
                          ...
                          <strong>Circle ID:</strong> <code className="ml-1 bg-gray-100 px-2 py-1 rounded text-xs font-mono">{request.circle._id}</code>
                        </div>
                      </div>
              ...
              <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                <div className="p-6 border-b border-gray-200">
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      <h3 className="text-2xl font-bold text-gray-900">{selectedCircle.name}</h3>
                      <p className="text-gray-600 mt-1">{selectedCircle.description || "No description provided"}</p>
                    </div>
                    <button 
                      onClick={() => setSelectedCircle(null)} 
                      className="text-gray-400 hover:text-gray-600 text-xl bg-gray-100 hover:bg-gray-200 rounded-full p-2 transition-colors"
                    >
                      ✕
                    </button>
                  </div>
                ...
                <div className="p-6">
                  ...
                  {isUserAdmin(selectedCircle) && (
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
                      <h4 className="text-lg font-semibold text-gray-900 mb-4">Admin Controls</h4>
                      ...
                      <form onSubmit={handleAddMember} className="flex gap-3 mb-6">
                        ...
                        <button 
                          type="submit" 
                          className="bg-green-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-green-700 whitespace-nowrap transition-colors"
                        >
                          Add Member
                        </button>
                      </form>
                        ...
                        <div className="mt-6">
                          ...
                          <div className="space-y-3">
                            {selectedCircle.joinRequests
                              ...
                              .map((request) => (
                                <div key={request._id} className="border border-gray-200 rounded-lg p-4 bg-white">
                      ...
                      <button 
                        ...
                        className="bg-blue-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-blue-700 mt-4 transition-colors"
                      >
                  ...
                  <div className="mb-8">
                    ...
                    <div className="space-y-3">
                      ...
                      {selectedCircle.members.map((member) => (
                        <div key={member._id} className="flex justify-between items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                          <div className="flex items-center gap-4">
                  ...
                  <div className="mt-6 text-sm text-gray-500 bg-gray-50 p-4 rounded-lg">
                    <p><strong>Circle ID:</strong> <code className="bg-gray-200 px-2 py-1 rounded font-mono text-xs">{selectedCircle._id}</code></p>
