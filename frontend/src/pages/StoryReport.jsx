    ...
    return (
        <div className="max-w-4xl mx-auto px-6 py-10">
            <div className="bg-white shadow-lg rounded-xl p-6 border-black border-2">
                ...
                {story.mediaType === "text" && <p className="text-gray-700 mb-4">{story.content}</p>}
                {story.mediaType === "photo" && story.mediaUrl && (
                    <img src={story.mediaUrl} alt={story.title} className="rounded-xl w-full max-h-96 object-cover mb-4" />
                )}
                ...
                {story.aiAnalysis && (
                    <div className="mt-6 border-t border-gray-200 pt-4">
                        ...
                        <p className="mb-2 text-gray-700">
                            <span className="font-semibold">Summary:</span> {story.aiAnalysis.summary}
                        </p>
                        <p className="mb-2 text-gray-700">
                            <span className="font-semibold">Category:</span> {story.aiAnalysis.category}
                        </p>
